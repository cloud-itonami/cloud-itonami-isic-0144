(ns flockops.phase
  "Phase gate for the sheep-and-goat farm operations coordinator rollout
  ...
  Phase 1: supervised operation -- always-escalate ops
    (`flockops.governor/always-escalate-ops`) escalate even when clean;
  ...
  (:require [flockops.governor :as governor]))
