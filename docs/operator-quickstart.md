# Operator Quickstart — Sheep & Goat Farm Operations Coordination

Shortest path from clone to a verified local dry-run for **ISIC 0144** (`cloud-itonami-isic-0144`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-0144.git
cd cloud-itonami-isic-0144
```
...
- Blueprint governor key: `flock-operations-governor`
- Likely source path: `flockops.governor.cljc`
